...
export const STATUS_UI: Record<ClaimStatus, { label: string; color: string; icon: React.ReactNode }> = {
  ...
  [ClaimStatus.PENDING_UNIT_HEAD]: { label: 'بانتظار اعتماد رئيس الوحدة', color: 'text-litcBlue bg-blue-50', icon: <ShieldCheck className="w-4 h-4" /> },
  ...
  [ClaimStatus.CORRECTION_REQUIRED]: { label: 'يتطلب تصحيح فني', color: 'text-orange-600 bg-orange-50', icon: <RotateCcw className="w-4 h-4" /> },

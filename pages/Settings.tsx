      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-1 space-y-4">
          <nav className="space-y-2">
            {[
              { label: 'الملف الشخصي', icon: <Smartphone className="w-4.5 h-4.5" />, active: true },
              { label: 'تنبيهات النظام', icon: <Bell className="w-4.5 h-4.5" />, active: false },
              { label: 'الأمان والخصوصية', icon: <Shield className="w-4.5 h-4.5" />, active: false },
              { label: 'اللغة والمنطقة', icon: <Globe className="w-4.5 h-4.5" />, active: false },
            ].map((item, idx) => (
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 p-8 rounded-[2rem] text-white shadow-xl shadow-indigo-100 overflow-hidden relative">
            <Sparkles className="absolute -top-4 -right-4 text-white/10 w-[100px] h-[100px]" />
